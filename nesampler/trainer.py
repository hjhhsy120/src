...
class _trainer(object):
    ...
    def __init__(self, graph, samples, rep_size=128, batch_size=1000, negative_ratio=5, ran=True):
        self.cur_epoch = 0
        self.g = graph
...
class trainer(object):
    ...
    def __init__(self, graph, samples, rep_size=128, batch_size=1000,
                epoch=10, negative_ratio=5, label_file=None, clf_ratio=0.5, auto_save=True, ran=True):
        self.rep_size = rep_size
        self.best_result = 0
        self.vectors = {}
